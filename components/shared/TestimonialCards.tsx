...
function TestimonialCards() {
  return (
    <div className="h-[40rem] border border-shadow rounded-lg w-full dark:bg-black dark:bg-grid-white/[0.2] relative flex flex-col items-center justify-center overflow-hidden">
